...
public class Bill implements Serializable {
    ...
    public Bill() {
        ...
        this.outputWarehouse = new OutputWarehouse();
    }
    ...
    public void displayBill(){
        System.out.printf("%-10s%-30s%-20s%-25s%-20s%-20s%-30s%-10s%s",number,date,outputWarehouse.getCode(),customer.getName(),customer.getCitizenID(),customer.getCompany(),
